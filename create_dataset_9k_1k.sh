#!/bin/bash
# Create dataset with 9000 training and 1000 validation samples
# Output files will be named: train_aa_9k_1k.faa, valid_aa_9k_1k.faa, etc.

# ./create_dataset_9k_1k.sh 2>&1 | tee create_dataset_9k_1k.log

set -e  # Exit on error

echo "=========================================="
echo "Creating 9k/1k Dataset"
echo "=========================================="
echo ""
...
echo ""
echo "Output files:"
echo "  train_aa_9k_1k.faa"
echo "  train_3di_9k_1k.faa"
echo "  valid_aa_9k_1k.faa"
echo "  valid_3di_9k_1k.faa"
echo ""
echo "You can now use these with finetune_prostt5_9k_1k.sh"
